...
function getInvertStyle(invert){
  ...
  let bodyTextShadow = !invert ? '' : 'body{text-shadow: 0px 0px 3px rgba(255, 255, 255, 0.5); -webkit-text-stroke-width: 0.25px; -webkit-text-stroke-color: rgba(128,128,128, 0.5);}'; //Difficult choice... what I'm doing?
